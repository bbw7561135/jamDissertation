...
\jamie{Change chapter title to reflect the work I've done more}
...
\jamie{Refs from snr cat paper aren't working yet}
...
the \twofgl \citep{Nolan12-2FGL}, based on $2$\,years of Source class data, within the RoI. To this we add pulsars from \twopc \citep{Abdo13-2PC}, based on $3$\,years of source class data, with 2PC taking precedence for sources that exist in both. 
