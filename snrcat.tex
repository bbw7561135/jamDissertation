...
One of the primary science goals of \Fermi~was to fill in the high energy gamma sky, the end of the EGRET era left us with 
\cite{Hartman99}

limit of EGRET was it's large error boxes (this just means not great spatial resolution right?)

\citep{Yadigaroglu97} \gam~sources correlate with massive star forming regions (sturnder dermer also?)
\begin{figure}[h!]%[t] 
	\centering
...
271 sources (above 100 \mev, 170 with no firm identification, 81 within \blat
    -what's to gain from studyng the population
