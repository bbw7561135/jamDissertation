...
Short chapter describing the diffuse emission
...
\jamie{Four steps to going from observing the sky to final LAT analysis: Instrument taking data: How we get to counts, Reconstruction : How we get photon. Likelihood: How to characterize sky using response functions, point source  and diffuse modeling. Likelihood for ES: how to use likelihood methods to char and resolve sources measure  extension}
